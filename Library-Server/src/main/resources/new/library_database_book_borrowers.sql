...
CREATE TABLE `book_borrowers` (
  ...
  PRIMARY KEY (`book_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `book_borrowers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `book_borrowers_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`)
...
-- Dump completed on 2024-11-29 15:23:48
