...
public class RightBarController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        for (int i = 0; i < 20; i++) {
            try {
                AnchorPane anchorPane = GetItemRightBarType1(DashBoardData.DASHBOARD_ITEM_RIGHT_BAR_TYPE_1);
    ...
    public AnchorPane GetItemRightBarType1(String link) throws IOException {
